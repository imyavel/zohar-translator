...
- **Переводчик другого длинного корпуса** (или Зоара с другим стилем) —
  это твой инструмент. Открой [`RUN_ME.md`](RUN_ME.md); LLM-агент
  проведёт тебя через 8 стадий адаптации.
...
Главная точка входа — **`RUN_ME.md`**. Это driver для LLM-агента
(Claude Code или аналога), который проводит оператора через 8 стадий
адаптации: окружение, источник, структура текста, словарь, промпт,
target публикации, smoke-run, hand-off.
